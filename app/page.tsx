    ...
    <main className="bg-white">
      ...
      <section className="relative overflow-hidden bg-[#1B4F72]">
        ...
        <div className="relative mx-auto grid min-h-screen w-full max-w-7xl items-center gap-10 px-4 pb-16 pt-32 sm:px-6 sm:pt-36 lg:grid-cols-[1.15fr_0.85fr] lg:px-8 2xl:min-h-[110vh]">
          ...
          >
            <p className="inline-flex rounded-full border border-white/25 bg-white/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.22em] text-slate-200">
              REIN Gebäudeservice – Hannover & Region
            </p>
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <Link
                href="/#kontakt"
                className="rounded-full bg-white px-6 py-3 text-sm font-semibold text-[#1B4F72] shadow-xl shadow-black/20 transition hover:-translate-y-0.5"
              >
                Angebot anfragen
              </Link>
              <Link
            ...
            {strengthsShowcase.map((item, index) => {
              ...
              return (
                <motion.article
                  ...
                  className={`absolute w-[38%] rounded-[1.6rem] p-6 shadow-xl ${
                    cardPositions[index]
                  } ${
                    item.tone === "brand"
                      ? "bg-[#1B4F72] text-white"
